...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 24 mai 2023 à 23:27
...
(12, 2, '10000000000', '2023-05-04 11:30:59'),
(13, 2, '10000000000', '2023-05-04 11:31:04'),
(14, 2, '10000000000', '2023-05-04 11:33:42'),
(15, 2, '10000000000', '2023-05-04 11:34:29');
...
(2, '10000000000', '10000000002', 'ABOULE UN MAX DE MOULA', '2023-03-12 12:00:00', '2023-03-09 01:35:00', 2),
(3, '10000000000', '10000000002', 'Bonjour donne des sous', '2023-03-25 10:22:00', '2023-03-09 08:07:00', 1),
(4, '10000000000', '10000000002', 'ABOULE UN MAX DE MOULA', '2023-03-24 21:20:00', '2023-03-09 10:21:00', 3),
(5, '10000000000', '10000000002', 'Aled', '2023-04-08 12:12:00', '2023-03-16 11:23:00', 3),
(6, '10000000000', '10000000002', 'DONNE RDV !!', '2023-04-14 12:40:00', '2023-04-06 10:40:00', 3),
(7, '10000000000', '10000000002', 'ABOULE UN MAX DE MOULA', '2023-04-30 12:30:00', '2023-04-27 08:32:00', 3),
(8, '10000000000', '10000000002', 'Bonjour donne des sous', '2023-04-15 12:20:00', '2023-04-27 10:33:00', 3),
(11, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-10 11:02:00', '2023-05-08 11:40:00', 3),
(12, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:11:00', 0),
(13, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:13:00', 0),
(14, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:16:00', 0),
(15, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:17:00', 0),
(16, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:18:00', 0),
(17, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:21:00', 0),
(18, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:22:00', 0),
(19, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:28:00', 0),
(20, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:28:00', 0),
(21, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:28:00', 0),
(22, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:28:00', 0),
(23, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:29:00', 0),
(24, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:29:00', 0),
(25, '10000000000', '10000000002', 'Nouveau rdv svp', '2023-05-13 12:11:00', '2023-05-23 03:29:00', 0);
...
--
-- Structure de la table `rdvindex`
--

DROP TABLE IF EXISTS `rdvindex`;
CREATE TABLE IF NOT EXISTS `rdvindex` (
  `id` int NOT NULL AUTO_INCREMENT,
  `lib` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `rdvindex`
--

INSERT INTO `rdvindex` (`id`, `lib`) VALUES
(0, 'Non-traité'),
(1, 'Accepté'),
(3, 'Refusé'),
(4, 'Annulé');
...
INSERT INTO `users` (`userid`, `nom`, `prenom`, `date_naissance`, `password`, `mail`, `tel`, `adresse`, `idconseiller`, `permissions`) VALUES
('10000000000', 'Zonca', 'Leo', '2003-10-11', '$2y$10$xMRFjixwqlBNBat6wBHZsuownuWH0B9mc9a8Sw92myXX22/1HeVdC', 'leo.zonca@wisemail.com', '0646347071', '4 Allée André Turcat, Meyzieu, France', '10000000002', 4),
('10000000001', 'Vernus', 'Paul', '2002-04-16', '$2y$10$FCPsCXK4f/lpdPpFPtxFI.J7rJFKhfFUNAGU2L3Xj7N8r8Fj325qK', 'paulvernus@wisemail.com', '0782586136', 'Villefranche', '20639419637', 1),
('10000000002', 'Mocanu', 'Miruna', '2003-04-03', '$2y$10$FCPsCXK4f/lpdPpFPtxFI.J7rJFKhfFUNAGU2L3Xj7N8r8Fj325qK', 'mirunamocanu@wisemail.com', '0617780388', 'Villefranche', '0', 3),
('11788131514', 'asd', 'cules', '2023-05-19', '$2y$10$t8xHAdSR5RfqIFDL7Wufl.SG5H6WxV64mY7u0H2MdOMobuhSb4t0S', 'dasda@ad', '+3369696969', 'ads', '20639419637\"', 1),
('20639419637', 'Lavaux', 'Bastien', '2004-07-21', '$2y$10$EKimhRi0Otuo0jy5H2Edd.p/4GSraDqrTXbOF6l2zS2uKJXODZlaO', 'bastien.lavaux@wisemail.com', '0750076268', 'Villeurbanne', '10000000002', 2),
('32407958244', 'tets', 'Tst_8', '2023-03-24', '$2y$10$ry5TxHGXQeU.Hny.hESYIOx96W2qgZAceuE8.Ym7yh5b5rrWahudi', 'WiseTree@tree', '45454', 'ads', '0', 1),
('39762984437', 'Testy', 'Test', '2023-03-15', '$2y$10$ujNHv9jzN1poUcm6n.fWWuvaSDM8.Aeyrua4C7Ueew6ud2hwf2RVa', 'tesy@tes', '+333532131', 'saf', '20639419637', 1),
('41157767050', 'Hawk', 'Mike', '2023-04-14', '$2y$10$DR.cTUYdS3FFWdobAaEbKe/eZcd2jb.5XDj6.a0VPQaA783Vd9vSS', 'Mike.hawk@gmail.com', '+333532131', 'walali', '20639419637\"', 1),
('42855391884', 'test', 'test', '2023-03-24', '$2y$10$FCPsCXK4f/lpdPpFPtxFI.J7rJFKhfFUNAGU2L3Xj7N8r8Fj325qK', 'test@mail', '+335114514', 'dsad', '0', 1),
('56844909537', 'Bull', 'Dreamy', '1992-02-18', '$2y$10$/Doitd/Y15cN8/IzvRW4rupSrDAhsGLCH.zQ/NhIbwWv8yn5iD/um', 'dreamybull@ambatakam.boutanat', '+3369696969', 'New York', '20639419637\"', 1),
('71043740740', 'Doutaz', 'Mathys', '2004-05-15', '$2y$10$QhqtlhuX4z.O.rybQQqKh.JPZDKsTyqz4AA2m9ijt30ZjFm9crqjO', 'mathysdoutaz@wisemail.com', '0783775444', 'Bouzolles', '', 3),
('77036964710', 'Cardeillac', 'Cyril', '2002-12-09', '$2y$10$fKJSrP/1tk7GkFJgKMK9wObfzuZcSwKm1puUV2Aic2pHbV3IWhP5i', 'cyril@wisemail.com', '+33 601470917', 'Villefranche', '20639419637\"', 1);
